...
impl PaleontologyLaws {
    ...
    /// 化石记录
    pub fn fossil_record(&self) -> Vec<&'static str> {
        vec![
            "化石形成: 生物遗体被沉积物掩埋经过矿化保存",
            "标准化石: 分布广数量多演化快的化石用于地层对比",
            "活化石: 形态长期变化不大的古老物种",
            "埋藏学: 研究生物从死亡到形成化石的过程",
            "古生态学: 通过化石重建古代生物的生活环境",
            "大灭绝: 地球历史上多次生物大规模灭绝事件",
        ]
    }

    /// 演化模式
    pub fn evolutionary_patterns(&self) -> Vec<&'static str> {
        vec![
            "渐变论: 进化是缓慢渐进的连续过程",
            "间断平衡: 物种长期稳定被短期快速变化打断",
            "趋同演化: 不同谱系独立进化出相似形态",
            "同源结构: 不同物种中来源相同的器官",
            "痕迹器官: 功能退化但保留祖先特征的器官",
            "寒武纪大爆发: 约5.4亿年前动物门类快速多样化",
        ]
    }
    ...
    pub fn human_evolution(&self) -> Vec<&'static str> {
        vec![
            "南方古猿: 约400万年前已直立行走的早期人科",
            "能人: 约200万年前最早制造石器的人属",
            "直立人: 约180万年前走出非洲的人种",
            "尼安德特人: 约40万至3万年前的欧洲古人类",
            "智人: 约30万年前起源的现代人类",
