...
impl AstronomyRules {
    ...
    /// 宇宙学定律
    pub fn cosmology_laws(&self) -> Vec<&'static str> {
        vec![
            "哈勃定律: 星系退行速度与距离成正比v=H₀d",
            "宇宙微波背景辐射: 大爆炸余辉温度约2.7K",
            "暗物质: 不发光但有引力效应占宇宙物质27%",
            "暗能量: 导致宇宙加速膨胀的未知能量占宇宙68%",
            "弗里德曼方程: 描述均匀各向同性宇宙演化的动力学方程",
            "宇宙暴胀: 早期宇宙经历指数级膨胀的理论",
    ...
    /// 天体物理定律
    pub fn astrophysics_laws(&self) -> Vec<&'static str> {
        vec![
            "钱德拉塞卡极限: 白矮星最大质量约1.4倍太阳质量",
            "奥本海默极限: 中子星最大质量约2-3倍太阳质量",
            "史瓦西半径: 黑洞事件视界的半径r=2GM/c²",
            "霍金辐射: 黑洞因量子效应发出热辐射最终蒸发",
            "爱丁顿光度: 恒星辐射压力与引力平衡的最大光度",
            "赫罗图: 恒星光度与表面温度的关系图",
            "主序星: 核心氢核聚变阶段的恒星",
        ]
    }
    ...
    pub fn exoplanet_science(&self) -> Vec<&'static str> {
        vec![
            "凌日法: 行星经过恒星前方时亮度略微下降",
            "径向速度法: 行星引力导致恒星周期性摆动",
            "宜居带: 行星表面可能维持液态水的轨道区域",
            "热木星: 距恒星极近的气态巨行星",
            "超级地球: 质量介于地球和海王星之间的行星",
            "开普勒任务: 发现数千颗系外行星的空间望远镜",
