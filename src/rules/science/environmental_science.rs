...
impl EnvironmentalScienceLaws {
    ...
    /// 气候变化
    pub fn climate_change(&self) -> Vec<&'static str> {
        vec![
            "温室效应: 大气中温室气体吸收红外辐射使地表升温",
            "辐射强迫: 外部因素对地球辐射能量平衡的影响",
            "气候敏感度: CO₂浓度加倍时全球平均温度升高2-4.5°C",
            "碳循环: 碳在大气海洋陆地和生物圈之间的循环",
            "米兰科维奇循环: 地球轨道参数变化驱动冰期旋回",
            "反照率效应: 冰雪融化减少太阳反射导致进一步升温",
            "海洋酸化: CO₂溶于海水形成碳酸降低海水pH值",
        ]
    }

    /// 生态系统规则
    pub fn ecosystem_rules(&self) -> Vec<&'static str> {
        vec![
            "生物多样性: 包含基因物种和生态系统三个层次",
            "生态足迹: 人类活动对地球生态系统的需求量",
            "承载力: 特定环境能支撑的最大种群数量",
            "生态演替: 生物群落随时间有序变化的过程",
            "关键种: 对生态系统结构功能有不成比例影响的物种",
            "食物网: 多个食物链交织成的复杂营养关系网络",
        ]
    }
    ...
    pub fn renewable_energy(&self) -> Vec<&'static str> {
        vec![
            "太阳能光伏: 利用半导体将光能直接转化为电能",
            "风力发电: 利用风能驱动发电机",
            "水力发电: 利用水的势能和动能发电",
            "生物质能: 利用有机物质转化的能源",
            "地热能: 利用地球内部热量的能源",
            "潮汐能: 利用月球和太阳引力产生的潮汐发电",
            "氢能: 利用氢气与氧气反应产生能量和水",
        ]
    }
