...
impl BioengineeringLaws {
    ...
    /// 基因工程
    pub fn genetic_engineering(&self) -> Vec<&'static str> {
        vec![
            "PCR技术: 体外扩增特定DNA片段的聚合酶链反应",
            "基因克隆: 将目的基因插入载体导入宿主细胞扩增",
            "CRISPR基因编辑: 利用Cas9蛋白定点切割DNA实现精准编辑",
            "基因治疗: 将正常基因导入患者细胞治疗遗传病",
            "转基因技术: 将外源基因导入生物体获得新性状",
            "基因文库: 包含生物体全部基因组DNA片段的克隆集合",
        ]
    }

    /// 生物过程工程
    pub fn bioprocess_engineering(&self) -> Vec<&'static str> {
        vec![
            "发酵工程: 利用微生物大规模生产有用物质",
            "酶工程: 利用酶的催化特性进行工业生产",
            "细胞培养: 在体外条件下使细胞生长增殖",
            "生物反应器: 为生物反应提供可控环境的容器",
            "下游加工: 从发酵液中分离纯化目标产物",
            "生物传感器: 利用生物分子识别特定分析物",
        ]
    }
    ...
    pub fn tissue_engineering(&self) -> Vec<&'static str> {
        vec![
            "支架材料: 为细胞提供三维生长环境的生物材料",
            "干细胞: 具有自我更新和多向分化能力的细胞",
            "生长因子: 调节细胞增殖分化的蛋白质信号分子",
            "生物打印: 利用3D打印技术构建组织和器官",
            "脱细胞基质: 去除细胞保留细胞外基质的生物支架",
            "组织血管化: 工程化组织中建立血管网络",
        ]
    }
