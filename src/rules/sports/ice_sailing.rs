...
impl IceSailingRules {
    pub fn new() -> Self {
        Self {
            metadata: RuleMetadata::new("冰上帆船规则", "冰上帆船比赛规则")
                .with_origin("北欧")
    ...
    pub fn competition_types(&self) -> Vec<&'static str> {
        vec!["竞速比赛", "花样比赛", "长距离比赛", "团体比赛", "综合比赛"]
    }

    /// 比赛规则
    pub fn competition_rules(&self) -> Vec<&'static str> {
        vec!["比赛路线", "时间限制", "出发规则", "终点判定", "安全规则"]
    }

    /// 技术动作
    pub fn techniques(&self) -> Vec<&'static str> {
        vec!["操控技术", "转向技术", "风帆控制", "速度控制", "安全技术"]
    }

    /// 装备要求
    pub fn equipment(&self) -> Vec<&'static str> {
        vec!["冰上帆船", "风帆装备", "防护服装", "安全装备", "冰面装备"]
    }

    /// 安全规则
    pub fn safety_rules(&self) -> Vec<&'static str> {
        vec!["冰面安全", "防护服装", "风力限制", "救援准备", "医疗支持"]
    }

    /// 评分标准
    pub fn scoring(&self) -> Vec<&'static str> {
        vec!["完成时间", "技术评分", "花样评分", "综合评分", "排名规则"]
    }
