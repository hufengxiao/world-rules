...
impl SteeplechaseRules {
    pub fn new() -> Self {
        Self {
            metadata: RuleMetadata::new("障碍跑规则", "田径障碍跑比赛规则")
                .with_origin("英国")
    ...
    pub fn competition_rules(&self) -> Vec<&'static str> {
        vec!["跨越障碍", "水坑规则", "犯规判定", "出发规则", "终点判定"]
    }

    /// 技术动作
    pub fn techniques(&self) -> Vec<&'static str> {
        vec!["跨越技术", "水坑技术", "跑步技术", "节奏控制", "落地技术"]
    }

    /// 犯规规则
    pub fn fouls(&self) -> Vec<&'static str> {
        vec!["绕过障碍", "踩踏障碍", "推挤犯规", "干扰对手", "违规穿越"]
    }

    /// 场地要求
    pub fn track_requirements(&self) -> Vec<&'static str> {
        vec!["标准跑道", "水坑设计", "障碍位置", "安全设施", "医疗支持"]
    }
