...
impl MudRacingRules {
    pub fn new() -> Self {
        Self {
            metadata: RuleMetadata::new("泥地摩托车规则", "泥地摩托车比赛规则")
                .with_origin("美国")
    ...
    pub fn techniques(&self) -> Vec<&'static str> {
        vec!["操控技术", "泥地控制", "转向技术", "跳跃技术", "花样动作"]
    }

    /// 装备要求
    pub fn equipment(&self) -> Vec<&'static str> {
        vec!["泥地摩托车", "防护头盔", "护具套装", "比赛服装", "安全装备"]
    }
...
impl Default for MudRacingRules {
    fn default() -> Self {
        Self::new()
    }
}

impl Rule for MudRacingRules {
...
mod tests {
    ...
    #[test]
    fn test_mud_racing_rules() {
        let rules = MudRacingRules::new();
