...
impl ModelAirplaneRules {
    pub fn new() -> Self {
        Self {
            metadata: RuleMetadata::new("模型飞机比赛规则", "模型飞机比赛规则")
                .with_origin("国际")
    ...
    pub fn techniques(&self) -> Vec<&'static str> {
        vec!["遥控操控", "飞行技术", "花样动作", "着陆技术", "维修技术"]
    }

    /// 装备要求
    pub fn equipment(&self) -> Vec<&'static str> {
        vec!["模型飞机", "遥控设备", "动力系统", "维修装备", "安全装备"]
    }
