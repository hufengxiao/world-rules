...
impl WaterSkiingDetailedRules {
    pub fn new() -> Self {
        Self {
            metadata: RuleMetadata::new("花样滑水规则", "花样滑水比赛规则")
                .with_origin("美国")
    ...
    pub fn techniques(&self) -> Vec<&'static str> {
        vec!["滑行技术", "控制技术", "花样技术", "跳跃技术", "回旋技术"]
    }

    /// 安全规则
    pub fn safety_rules(&self) -> Vec<&'static str> {
        vec!["救生衣佩戴", "安全区域", "船只安全", "救援准备", "医疗支持"]
    }

    /// 装备要求
    pub fn equipment(&self) -> Vec<&'static str> {
        vec!["滑水板", "牵引绳", "救生衣", "防护装备", "船只装备"]
    }
