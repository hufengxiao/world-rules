...
impl PaddleboardingRules {
    pub fn new() -> Self {
        Self {
            metadata: RuleMetadata::new("站立式桨板规则", "站立式桨板运动规则")
                .with_origin("夏威夷")
    ...
    pub fn competition_types(&self) -> Vec<&'static str> {
        vec!["竞速比赛", "花样比赛", "大浪比赛", "长距离比赛", "技术比赛"]
    }

    /// 比赛规则
    pub fn competition_rules(&self) -> Vec<&'static str> {
        vec!["比赛距离", "时间限制", "评分标准", "风力要求", "安全规则"]
    }

    /// 技术动作
    pub fn techniques(&self) -> Vec<&'static str> {
        vec!["基础划桨", "转向技巧", "波浪技巧", "竞速技术", "花样动作"]
    }

    /// 评分标准
    pub fn scoring(&self) -> Vec<&'static str> {
        vec!["完成时间", "技术表现", "波浪选择", "花样难度", "流畅性"]
    }

    /// 安全规则
    pub fn safety_rules(&self) -> Vec<&'static str> {
        vec!["救生装备", "安全区域", "风力限制", "救援准备", "医疗支持"]
    }

    /// 装备要求
    pub fn equipment(&self) -> Vec<&'static str> {
        vec!["桨板装备", "划桨", "防护装备", "救生装备", "附属配件"]
    }
