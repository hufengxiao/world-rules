...
pub mod hearthstone;
pub mod magic_the_gathering;
pub mod omaha;
pub mod poker;
pub mod seven_card_stud;
pub mod short_deck;
pub mod uno_detailed;
pub mod yugioh;
...
pub use hearthstone::HearthstoneBasicRules;
pub use magic_the_gathering::MagicTheGatheringBasicRules;
...
pub use uno_detailed::UnoDetailedRules;
pub use yugioh::YuGiOhBasicRules;
