...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Projects/world-rules/.hermes/.gsd-surface.json`
(sibling to `D:/Projects/world-rules/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/Projects/world-rules/.hermes/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/Projects/world-rules/.hermes/skills`).
...
`D:/Projects/world-rules/.hermes/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/Projects/world-rules/.hermes/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/Projects/world-rules/.hermes/.gsd-surface.json`
Install profile marker: `D:/Projects/world-rules/.hermes/.gsd-profile`
Skill dirs: `D:/Projects/world-rules/.hermes/skills/gsd-*/`
Engine module: `D:/Projects/world-rules/.hermes/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/Projects/world-rules/.hermes/gsd-core/bin/lib/clusters.cjs`
</execution_context>
