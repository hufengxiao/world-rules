...
<required_reading>
@D:/Projects/world-rules/.hermes/gsd-core/references/ai-frameworks.md
@D:/Projects/world-rules/.hermes/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Projects/world-rules/.hermes/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Projects/world-rules/.hermes/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Projects/world-rules/.hermes/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Projects/world-rules/.hermes/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Projects/world-rules/.hermes/agents/gsd-eval-planner.md for instructions.
