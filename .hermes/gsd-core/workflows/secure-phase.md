...
```
Agent(
  prompt="Read D:/Projects/world-rules/.hermes/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/world-rules/.hermes/gsd-core/templates/SECURITY.md`
