...
```markdown
Read D:/Projects/world-rules/.hermes/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Projects/world-rules/.hermes/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Projects/world-rules/.hermes/agents/gsd-ui-checker.md for instructions.
