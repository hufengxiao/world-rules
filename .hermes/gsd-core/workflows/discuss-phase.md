...
<required_reading>
@D:/Projects/world-rules/.hermes/gsd-core/references/domain-probes.md
@D:/Projects/world-rules/.hermes/gsd-core/references/gate-prompts.md
@D:/Projects/world-rules/.hermes/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "D:/Projects/world-rules/.hermes/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@D:/Projects/world-rules/.hermes/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
