...
<template>
@D:/Projects/world-rules/.hermes/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/Projects/world-rules/.hermes/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/Projects/world-rules/.hermes/gsd-core/workflows/transition.md`.
...
- Follow @D:/Projects/world-rules/.hermes/gsd-core/workflows/diagnose-issues.md
