...
Key references:
- @D:/Projects/world-rules/.hermes/gsd-core/references/ui-brand.md (display patterns)
- @D:/Projects/world-rules/.hermes/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Projects/world-rules/.hermes/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Projects/world-rules/.hermes/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/Projects/world-rules/.hermes/gsd-core/USER-PROFILE.md" "D:/Projects/world-rules/.hermes/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Projects/world-rules/.hermes/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Projects/world-rules/.hermes/gsd-core/references/user-profiling.md`
...
Reference: @D:/Projects/world-rules/.hermes/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/Projects/world-rules/.hermes/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global HERMES.md" -- "Add profile to D:/Projects/world-rules/.hermes/HERMES.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Projects/world-rules/.hermes/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Projects/world-rules/.hermes/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/Projects/world-rules/.hermes/HERMES.md"
...
```bash
BACKUP_PATH="D:/Projects/world-rules/.hermes/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Projects/world-rules/.hermes/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Projects/world-rules/.hermes/skills/gsd-dev-preferences/SKILL.md
  ✓ HERMES.md section       ./HERMES.md
  ✓ Global HERMES.md        D:/Projects/world-rules/.hermes/HERMES.md
```
