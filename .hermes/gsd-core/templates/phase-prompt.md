...
<!-- For checkpoint task examples and patterns, see @D:/Projects/world-rules/.hermes/gsd-core/references/checkpoints.md -->
...
See `D:/Projects/world-rules/.hermes/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/Projects/world-rules/.hermes/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/Projects/world-rules/.hermes/gsd-core/workflows/verify-phase.md` for verification logic.
