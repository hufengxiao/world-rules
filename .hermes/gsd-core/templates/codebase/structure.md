...
- Usage: Reference from command with `@D:/Projects/world-rules/.hermes/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/Projects/world-rules/.hermes/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Projects/world-rules/.hermes/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
