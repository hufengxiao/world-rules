...
<reference>
@D:/Projects/world-rules/.hermes/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Projects/world-rules/.hermes/gsd-core/references/user-profiling.md` to load:
