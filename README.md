...
一个全面的 Rust 规则库，包含 **1000+** 条可用规则，覆盖游戏、体育、社交礼仪、科学、法律、健康六大领域。提供真实可用的算法实现，包括麻将胡牌判定、扑克牌型评估、象棋走子验证等。

## ✨ 特性

### 🎮 游戏规则 (150+ 条)
- **麻将体系**：四川麻将、国标麻将、日本麻将等 25+ 变体，支持完整胡牌判定与听牌检测
- **扑克游戏**：德州扑克、斗地主、21点、桥牌、掼蛋、跑得快、升级
- **棋类游戏**：中国象棋、国际象棋、围棋、五子棋、军棋等
- **桌游**：麻将牌、扑克牌等
...
- **商法规则**：公司法、证券法、破产法
- **程序法规则**：民事、刑事、行政诉讼程序
- **实务生活法律**：消费者权益、房屋租赁、劳动合同、邻里纠纷、交通事故、遗产继承、婚姻财产、保险理赔等

### 🏃 体育规则 (300+ 条)
- 足球、篮球、网球、乒乓球、羽毛球、田径等竞技规则
- 大众健身礼仪：匹克球、慢跑、瑜伽、团操、器材共享、观赛礼仪、尊重裁判、运动精神等

### 🤝 社交礼仪 (160+ 条)
- 商务礼仪、餐桌礼仪、网络礼仪、职场礼仪
- 公共出行：地铁、公交、机场、出租车、扶梯、行人
- 生活场景：公园、菜市场、医院候诊、超市、药店、理发店、图书馆
- 人际往来：待客、奉茶、敬酒、引荐、致谢、领奖、家宴、乔迁、探访、捐赠、志愿服务

### 🔬 科学定律 (200+ 条)
- 物理定律、化学定律、生物定律、数学概率与统计
- 实验室安全、数字素养、统计伦理、实验方法、问卷设计

### 🏥 健康规则 (150+ 条)
- 慢性病管理：高血压、血糖/糖尿病、血脂、甲状腺、睡眠呼吸暂停、痛风、贫血
- 急救应急：心肺复苏CPR、海姆立克法、烫烧伤、扭伤、中暑、溺水、地震避险、急救箱
- 日常健康：均衡膳食、营养、补水、防晒、护眼、护膝、拉伸、洗手卫生
- 特定人群：老人防跌倒、素食营养、经前综合征、戒烟、青少年健康

## 📊 项目规模

- **总规则数**: 1180+ 条（CLI 可用 1181 条：游戏151 / 体育302 / 社交161 / 科学209 / 法律203 / 健康155）
- **代码行数**: 298,000+ 行
- **源文件数**: 2,000+ 个 Rust 文件
- **测试覆盖**: 4,800+ 个测试，集成测试 + 属性测试 (proptest)
- **性能基准**: criterion 基准测试
