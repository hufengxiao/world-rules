...
一个全面的 Rust 规则库，包含 **800+** 条可用规则，覆盖游戏、体育、社交礼仪、科学、法律、健康六大领域。提供真实可用的算法实现，包括麻将胡牌判定、扑克牌型评估、象棋走子验证等。
...
- **总规则数**: 800+ 条（CLI 可用 882 条）
- **代码行数**: 249,000+ 行
- **源文件数**: 1,700+ 个 Rust 文件
- **测试覆盖**: 3,700+ 个测试，集成测试 + 属性测试 (proptest)
- **性能基准**: criterion 基准测试
